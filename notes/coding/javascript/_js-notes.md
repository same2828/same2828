...
```js
const regex1 = /(?!"paths"|"default"|"requestPath")("[a-z]+([\-].*?)*[a-z0-9]": {)/g;
// Note: Not sure why Prettier removes the \- in the regex below
const regex2 = new RegExp('(?!"paths"|"default"|"requestPath")("[a-z]+([-].*?)*[a-z0-9]": {)', 'g');
